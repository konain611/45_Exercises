...
const famous_persone : String = "Khalid Ibn Walid (R.A)";
const massage: string = `${famous_persone} once said, "It's better to die on your Feet, than to live on your Knees"`;
